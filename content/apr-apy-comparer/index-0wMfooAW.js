...
`;class rn extends X{static properties={principal:{type:Number},mode:{type:String},startDate:{type:String,attribute:"start-date"},periodDays:{type:Number,attribute:"period-days"},currency:{type:String},results:{type:Object},loanRateInput:{state:!0},termMonthsInput:{state:!0},apyInput:{state:!0},paymentValue:{state:!0},interestValue:{state:!0}};constructor(){super(),this.principal=void 0,this.mode="idealized",this.startDate="",this.periodDays=void 0,this.currency="USD",this.results={},this.loanRateInput="",this.termMonthsInput="",this.apyInput="",this.paymentValue=Number.NaN,this.interestValue=Number.NaN,this._calculator=new ot,this._loanData=null,this._depositData=null}updated(e){if(e.has("periodDays")){const t=Number.isInteger(this.periodDays)?this.periodDays:void 0;this._calculator=new ot({periodDays:t})}(e.has("principal")||e.has("mode")||e.has("startDate")||e.has("periodDays"))&&(this._calculateLoan(),this._calculateDeposit(),this._calculateCombined())}render(){const e=O(this.paymentValue,this.currency),t=O(this.interestValue,this.currency),n=O(this.results?.depositInterest,this.currency),i=O(this.results?.savingsEndBalance,this.currency),s=O(this.results?.loanSavingsCost,this.currency);return z`
      ...
      <div class="option-card savings-card">
        ...
        <div class="mini-results">
          ...
          <p>
            ...
            <span data-role="savings-balance">${i}</span>
          </p>
          <p>
            <span class="label">Loan + savings net cost:</span>
            <span data-role="loan-savings-cost">${s}</span>
          </p>
    ...
    `}_renderSummary(e){const t=O(e.loanInterest,this.currency),n=O(e.loanSavingsCost,this.currency),i=O(e.cardRewards,this.currency),s=O(e.cardInterest,this.currency);return z`
